...
export function Solutions() {
  return (
    <div className="relative w-full bg-white overflow-hidden">
      <img
        className="absolute top-[4538px] left-[500px] w-[1512px] h-[416px] -z-10 pointer-events-none"
        alt="Vector"
        src="/figmaAssets/vector-21.svg"
      />

      <img
        className="absolute top-[2518px] left-[-428px] w-[1512px] h-[416px] -z-10 pointer-events-none"
        alt="Vector"
        src="/figmaAssets/vector-20-1.svg"
      />

      <img
        className="absolute top-[1608px] left-[385px] w-[1512px] h-[416px] -z-10 pointer-events-none"
        alt="Vector"
        src="/figmaAssets/vector-20.svg"
      />

      <img
        className="absolute top-0 left-0 w-[1044px] h-[879px] -z-10 pointer-events-none"
        alt="Vector"
