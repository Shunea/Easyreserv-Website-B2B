...
const getNavigationItems = (t: (key: string) => string) => [
  ...
  { label: t('nav.solutions'), hasDropdown: true, href: "/solutions" },
          ...
          <div className="flex items-center gap-2">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <div className="flex items-center gap-2 px-3 py-2 rounded-lg border-[0.5px] border-solid border-[#28282880] cursor-pointer hover:bg-gray-50 transition-colors">
                  ...
                  <ChevronDownIcon className="w-4 h-4 text-[#282828]" />
                </div>
              </DropdownMenuTrigger>
