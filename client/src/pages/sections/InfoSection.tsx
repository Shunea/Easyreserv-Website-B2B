    ...
    <section className="flex flex-col items-center w-full">
      ...
      <footer className="flex flex-col w-full max-w-[1440px] items-center justify-center gap-[53px] px-[180px] py-[50px] bg-[#191a24]">
        <div className="flex items-start justify-center gap-[43px] w-full">
          <div className="flex flex-col items-start gap-4 flex-1">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center justify-center w-[164px] h-14 [font-family:'Inter',Helvetica] font-semibold text-white text-2xl tracking-[0] leading-[33.6px]">
                EasyReserv.io
              </div>
            </div>

            <p className="opacity-75 [font-family:'Inter',Helvetica] font-normal text-white text-sm tracking-[0] leading-[normal]">
          ...
          <div className="flex items-start justify-center flex-1 gap-8">
            <nav className="flex flex-col items-start gap-4 flex-1">
              {footerLinks.column1.map((link, index) => (
                <a
                  key={index}
                  href="#"
                  className="[font-family:'Inter',Helvetica] font-normal text-white text-base tracking-[-0.32px] leading-[normal] hover:underline"
                >
                  {link}
                </a>
              ))}
            ...
            <div className="flex flex-col items-start gap-2">
              <div className="[font-family:'Inter',Helvetica] font-normal text-white text-base text-center tracking-[0] leading-[normal]">
                Available on
              </div>
        ...
        <div className="flex items-center justify-between w-full">
          ...
          <div className="opacity-50 [font-family:'Inter',Helvetica] font-normal text-white text-base text-center leading-4">
